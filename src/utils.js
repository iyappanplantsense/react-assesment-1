...
export const State = [
  ...
  export const schemaList = [
    ...
    { Label: 'Gender', Value: 'gender',type:'Radio',options:[{value:'male',label:'Male'},{value:'female',label:'Female'},{value:'other',label:'Other'}]},
    { Label: 'Age', Value: 'age',type:'Text'},
    { Label: 'Account Name', Value: 'account_name',type:'Text'},
    { Label: 'City' ,Value: 'city',type:'Select',options:Cities,optionLabel:'name'},
    { Label: 'State' ,Value: 'state',type:'Select',options:State,optionLabel:'name'}]